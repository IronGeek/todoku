...
import { BarChartIcon, CurrencyIcon, DatabaseIcon, TicketIcon } from '@/ui/icons.ts';
...
const BenefitCard = ({ children, className, icon, image, title, ...props }: BenefitCardProps): JSX.Element => (

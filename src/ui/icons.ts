...
import AsteriskIcon from '@/ui/icons/asterisk.svg';
import BarChartIcon from '@/ui/icons/bar-chart.svg';
import BinocularsIcon from '@/ui/icons/binoculars.svg';
...
import CrossHairIcon from '@/ui/icons/crosshair.svg';
import CurrencyIcon from '@/ui/icons/currency.svg';
import DatabaseIcon from '@/ui/icons/database.svg';
import EditIcon from '@/ui/icons/edit.svg';
import FacebookIcon from '@/ui/icons/facebook.svg';
import GithubIcon from '@/ui/icons/github.svg';
import GitlabIcon from '@/ui/icons/gitlab.svg';
import HashIcon from '@/ui/icons/hash.svg';
import HeartPulseIcon from '@/ui/icons/heart-pulse.svg';
import ImageAltIcon from '@/ui/icons/image-alt.svg';
import IncognitoIcon from '@/ui/icons/incognito.svg';
...
import PersonArmsUpIcon from '@/ui/icons/person-arms-up.svg';
import PersonHeartsIcon from '@/ui/icons/person-hearts.svg';
...
import TwitterXIcon from '@/ui/icons/twitter-x.svg';
import UpRightIcon from '@/ui/icons/up-right.svg';
import UpcomingIcon from '@/ui/icons/upcoming.svg';
import XLgIcon from '@/ui/icons/x-lg.svg';
import XIcon from '@/ui/icons/x.svg';
import YoutubeIcon from '@/ui/icons/youtube.svg';
...
export {
  ...
  CalendarIcon, TagIcon, CheckIcon, CircleIcon, EditIcon, AIIcon, AsteriskIcon,
  ChevronLeftIcon, ChevronRightIcon, ChevronDownIcon, ChevronUpIcon, ImageAltIcon,

...
import { Writable, GroupedTodos, Todos, Todo, SetItemCompleted } from './types';
...
const { setTodos, resetTodos, setItemCompleted } = todosSlice.actions;

export { todosReducer, setTodos, resetTodos, setItemCompleted }
